...
const DataServices = () => {
    ...
    const activeService = dataServicesData[activeIndex];
    return (
        <div className="bg-white min-h-screen text-gray-900">
            <section className="flex flex-col md:flex-row items-center justify-between px-4 py-8 bg-white shadow rounded-lg max-w-5xl mx-auto mb-8">
                <div className="md:w-2/3 space-y-4">
                    <h2 className="text-2xl font-bold text-blue-700 mb-2">Data Services</h2>
                    <p className="text-gray-700">At Intekbit Solutions Pvt. Ltd., we offer a comprehensive range of Data Services to help businesses manage, analyze, and leverage their data for smarter decision-making. Our goal is to provide scalable and secure data solutions tailored to your organization's needs.</p>
                    <h3 className="text-lg font-semibold text-blue-600">Our Data Services Include:</h3>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
                        <li>Data Integration & Governance</li>
                ...
                <div className="md:w-1/3 flex justify-center mt-6 md:mt-0">
                    <img src="/Assets/internal-data-services.webp" alt="Data Services" className="w-64 h-48 object-cover rounded-lg shadow" />
                </div>
            </section>
            <section className="max-w-5xl mx-auto bg-white rounded-lg shadow p-6">
                <div className="flex flex-wrap gap-2 mb-6">
                    {dataServicesData.map((item, idx) => (
                        <button
                            key={item.title}
                ...
                <div className="space-y-8">
                    {activeService.sections.map((section) => (
                        <div key={section.sectionTitle} className="bg-blue-50 rounded-lg p-6 shadow">
                            <h3 className="text-xl font-bold mb-2 text-blue-700">{section.sectionTitle}</h3>
