          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                As a trusted IT solutions partner, we provide end-to-end
                services in web development, mobile app development, UI/UX
                design, graphic design, AI & ML, and data solutions. Our
                future-ready approach tackles business challenges, blends
                innovation with technology, ensures security and reliability,
                boosts productivity, and delivers exceptional user experiences
