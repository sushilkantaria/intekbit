  ...
  const processSteps = [
    {
      ...
      description:
        'We gather and analyze your business needs through discussions and research to define a clear project scope.',
      icon: '/Assets/home-process-req.gif',
    },
    {
      title: 'Planning & Strategy',
      description:
        'A strategic roadmap is created with structured workflows and intuitive design for an optimal user experience.',
      icon: '/Assets/home-process-planning.gif',
    },
    {
      title: 'Design & Development',
      description:
        'We craft wireframes and prototypes before transforming them into a functional, high-performance solution.',
      icon: '/Assets/home-process-design.gif',
    },
    {
      title: 'Testing & Quality Assurance',
      description:
        'Rigorous testing ensures functionality, security, and performance, delivering a seamless user experience.',
      icon: '/Assets/home-process-testing.gif',
    },
    {
      title: 'Deployment & Implementation',
      description:
        'We launch the solution with a secure, scalable deployment strategy for smooth business integration.',
      icon: '/Assets/home-process-deploy.gif',
    },
    {
      title: 'Support & Continuous Improvement',
      description:
        'Ongoing support, updates, and optimizations ensure the product evolves with your business needs.',
      ...
      <section className="py-16 bg-gray-50" id="about">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 px-4">
            ...
            <div className="text-gray-700">
              {activeTab === 'mission' && (
                <p>
                  ...
                  smart, AI-powered solutions while staying by your side every
                  step of the way. Our goal is to deeply understand your needs,
                  deliver meaningful results, and create lasting partnerships.
                </p>
              )}
              {activeTab === 'vision' && (
                <p>
                  We envision a world where innovation meets trust, and
                  challenges become stepping stones to success. At Intekbit, we
                  aim to inspire confidence and empower growth with solutions
          ...
          <div className="flex-1 space-y-4 text-gray-700">
            <p>
              At Intekbit Solutions Pvt. Ltd., we transform problem statements
              into cutting-edge AI-powered solutions that simplify processes,
              save time, and embrace the future. We thrive on challenges and
              focus on delivering solutions that go beyond expectations. By
              blending creativity with a deep understanding of technology, we
              craft efficient, tailored systems that redefine modern
              problem-solving.
            </p>
            <p>
              What sets us apart is our unwavering commitment to collaboration.
              At Intekbit Solutions, we don't work for clients – we work with
              clients. Shoulder to shoulder, hand in hand, we stand by them
              through every challenge, ensuring their journey is as seamless as
              the solutions we deliver.
            </p>
            <p>
              With trust and innovation as our core principles, we don't just
              solve problems – we create opportunities for growth, efficiency,
              and staying ahead in a constantly evolving world. Let Intekbit
              Solutions pave the way to your success with solutions that matter
              today and excel tomorrow.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex-1 flex flex-col items-center">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div
                ...
                onClick={() => showService('web')}
              >
                <img
                  src="/Assets/home-webdevelopment.webp"
                  alt="Web Development"
                  className="w-28 h-20 object-cover rounded shadow group-hover:scale-105 transition"
                />
                <h3 className="text-center mt-2 text-blue-700 font-semibold">
                  Web Development
                </h3>
              </div>
              <div
                className="cursor-pointer group"
                onClick={() => showService('ai')}
              >
                <img
                  src="/Assets/home-aiml.webp"
                  alt="AI & ML Solutions"
                  className="w-28 h-20 object-cover rounded shadow group-hover:scale-105 transition"
                />
                <h3 className="text-center mt-2 text-blue-700 font-semibold">
              ...
              <div
                className="cursor-pointer group"
                onClick={() => showService('mobile')}
              >
                <img
                  src="/Assets/home-appdevelopment.webp"
                  alt="App Development"
                  className="w-28 h-20 object-cover rounded shadow group-hover:scale-105 transition"
                />
                <h3 className="text-center mt-2 text-blue-700 font-semibold">
              ...
              <div
                className="cursor-pointer group"
                onClick={() => showService('it_consulting')}
              >
                <img
                  src="/Assets/home-itconsulting.webp"
                  alt="IT Consulting"
                  className="w-28 h-20 object-cover rounded shadow group-hover:scale-105 transition"
                />
                <h3 className="text-center mt-2 text-blue-700 font-semibold">
              ...
              <div
                className="cursor-pointer group"
                onClick={() => showService('data')}
              >
                <img
                  src="/Assets/home-dataservices.webp"
                  alt="Data Services"
                  className="w-28 h-20 object-cover rounded shadow group-hover:scale-105 transition"
                />
                <h3 className="text-center mt-2 text-blue-700 font-semibold">
              ...
              <div
                className="cursor-pointer group"
                onClick={() => showService('software')}
              >
                <img
                  src="/Assets/home-softwaredevelopment.webp"
      ...
      <section className="py-16 bg-gray-50" id="technology">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {technologies[activeTechnology]?.map((tech, index) => (
            <div
              key={index}
              className="flex flex-col items-center bg-white rounded shadow p-4 w-32"
            >
      ...
      <section className="py-16 bg-white" id="founders">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded shadow p-6 w-64">
            ...
            <a
              href="https://www.linkedin.com/in/archana-devmorari-844475332/"
              target="_blank"
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded shadow p-6 w-64">
            ...
            <a
              href="https://www.linkedin.com/in/sushil-kantaria/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2"
            >
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded shadow p-6 w-64">
            ...
            <a
              href="https://www.linkedin.com/in/parmi-gajera-a29274333/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2"
            >
