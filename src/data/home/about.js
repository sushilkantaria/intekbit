const aboutData = {
  ...
  aboutParagraphs: [
    ...
    `With trust and innovation as our core principles, we don't just solve problems – we create opportunities for growth, efficiency, and staying ahead in a constantly evolving world.`,
  ],
};
