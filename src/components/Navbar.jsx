      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-2 sm:px-4 md:px-8 py-2 md:py-3 relative">
        ...
        >
          <ul className="flex gap-4 sm:gap-8 items-center px-2 sm:px-8 py-2 rounded-full max-w-xl w-full justify-center shadow-[0_2px_12px_0_rgba(30,58,138,0.13),0_1px_8px_0_rgba(136,19,55,0.10),0_1px_6px_0_rgba(202,138,4,0.08),0_1px_4px_0_rgba(6,78,59,0.08),inset_0_2px_16px_0_rgba(255,255,255,0.10),inset_0_0_12px_2px_rgba(255,255,255,0.07),inset_0_0_0_1px_rgba(255,255,255,0.05)] backdrop-blur-lg backdrop-saturate-150">
            <li>
              <Link
                to="/"
                className="font-bold text-sm sm:text-base md:text-xl bg-gradient-to-r from-cyan-500 via-fuchsia-500 to-blue-500 bg-clip-text text-transparent hover:text-gray-600 transition-colors"
                data-aos="fade-down"
            ...
            <li>
              <Link
                to="/about"
                className="font-bold text-sm sm:text-base md:text-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-fuchsia-500 bg-clip-text text-transparent transition-colors duration-300 hover:from-fuchsia-500 hover:to-blue-500 hover:bg-gradient-to-rb hover:bg-clip-text hover:text-transparent"
                data-aos="fade-down"
              >
                About
              </Link>
        ...
        >
          <div className="relative w-fit">
            <Link
              to="/contact"
              className="peer text-lg inline-flex items-center relative px-4 sm:px-6 py-2  bg-gradient-to-r from-cyan-500 via-fuchsia-500 to-blue-500 bg-clip-text text-transparent rounded-3xl transition shadow-[0_2px_12px_0_rgba(30,58,138,0.18),0_1px_8px_0_rgba(136,19,55,0.13),0_1px_6px_0_rgba(202,138,4,0.10),0_1px_4px_0_rgba(6,78,59,0.10),inset_0_2px_16px_0_rgba(255,255,255,0.13),inset_0_0_12px_2px_rgba(255,255,255,0.10),inset_0_0_0_1px_rgba(255,255,255,0.07)] font-bold text-center z-10 gap-2 backdrop-blur-lg backdrop-saturate-150"
            >
      ...
      {isMenuOpen && (
        ...
        >
          <li className="w-full flex justify-center">
            <Link
              to="/"
              className="block w-full text-center py-2 rounded-lg font-bold text-base text-gray-100 hover:text-blue-400"
              onClick={(e) => {
                setIsMenuOpen(false);
                handleHomeClick(e);
              }}
          ...
          <li className="w-full flex flex-col items-center">
            <button
              className="w-full text-center py-2 rounded-lg font-bold text-base text-gray-100 hover:text-blue-400 flex items-center justify-center gap-2 focus:outline-none"
          ...
          <li className="w-full flex justify-center">
            <Link
              to="/contact"
              className="block w-full text-center py-2 rounded-lg font-bold text-base text-gray-100"
              onClick={() => setIsMenuOpen(false)}
            >
              Contact Us
            </Link>
