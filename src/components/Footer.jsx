  ...
  return (
    <footer className="text-white pt-12 bg-[#141414]">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-8 flex flex-col gap-10 md:gap-8 lg:gap-0 md:flex-row md:flex-wrap lg:flex-nowrap items-center justify-center md:items-start md:justify-start">
        ...
        <div className="flex-1 flex flex-col items-center text-center mb-6 md:items-start md:text-left md:mb-0 min-w-[180px]">
          <Link to="/">
            <img
              ...
              className="h-16 sm:h-15 w-auto mb-2"
              alt="Intekbit Logo"
            />
          </Link>
          <p className="text-gray-300 text-lg sm:text-sm md:text-base max-w-xs">
            Driven by Technology, Powered by Trust.
          </p>
        </div>
        {/* Quick Links */}
        <div className="flex-1 min-w-[140px] mb-6 text-center md:text-left md:mb-0">
          <h3 className="font-semibold mb-2 text-xl sm:text-lg md:text-lg">
            Quick Links
          </h3>
          <ul className="space-y-1">
            <li>
              <Link
                to="/"
                className="hover:text-blue-400 text-lg sm:text-sm md:text-base"
              >
                Home
              </Link>
            </li>
        ...
        {/* Contact Us */}
        <div className="flex-1 min-w-[180px] mb-6 items-center text-center md:items-start md:text-left md:mb-0">
          <h3 className="font-semibold mb-2 text-xl sm:text-lg md:text-lg">
            Contact Us
          </h3>
          <p className="flex items-center justify-center md:justify-start text-gray-300 text-lg sm:text-sm md:text-base mb-1">
          ...
          <p className="flex items-start justify-center md:justify-start text-gray-300 text-lg sm:text-sm md:text-base">
        ...
        {/* Social Links */}
        <div className="flex-1 min-w-[140px] mb-6 text-center md:text-left md:mb-0">
          <h3 className="font-semibold mb-2 text-xl sm:text-lg">Follow Us</h3>
      ...
      {/* Policy Links */}
      <div className="flex flex-col mt-6 sm:flex-row justify-center items-center gap-2 mb-2 text-white text-sm">
