...
>
  ...
  {industries.map((item, index) => (
    ...
    >
      ...
      <h3 className="text-gray-800 font-medium text-base md:text-lg">{item}</h3>
    </div>
  ))}
</div>
...
<section className="w-screen bg-white py-16 px-4 md:px-8" data-aos="fade-up" data-aos-duration="1000">
