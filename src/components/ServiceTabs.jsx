    ...
    <div>
      <div className="max-w-6xl mx-auto">
        ...
        <section className="text-white max-w-7xl mx-auto py-4">
          ...
          <p className="mb-5 text-gray-400 text-base leading-relaxed text-left">
            {techStackDescription}
          </p>
        ...
        <section className=" text-white text-center px-8 my-12">
          ...
          <button
            className="bg-red-500 text-white text-base px-8 py-3 mt-4 rounded-md hover:bg-red-600 transition-colors duration-300"
            onClick={() => navigate('/contact')}
          >
            {contactCtaText}
          </button>
