...
//   return (
//     <div className="rounded-2xl backdrop-blur-lg text-black backdrop-saturate-150   overflow-hidden flex flex-col hover:scale-[1.03] transition-transform duration-300 min-h-[300px] max-h-[420px]">
//       <img
//         src={post.image}
//         alt={post.title}
