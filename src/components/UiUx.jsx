...
export default function UiUx() {
  return (
    <div className="justify-center items-center min-h-screen">
      ...
      <div className="absolute top-35 left-22 h-26 w-26 overflow-hidden">
      ...
      <div className="absolute bottom-70 left-22 h-26 w-26 overflow-hidden">
        <span className="absolute top-0 left-0 w-full h-full border-2 border-[#00aaff] rounded-lg box-border animate-draw-border pointer-events-none" />
        <img
      ...
      {/* Pulsing Stack */}
      <div className="absolute bottom-70 right-26 flex flex-col gap-2 animate-pulse-stack">
        {[...Array(3)].map((_, i) => (
          <img
            key={i}
