...
export default function UiUx() {
  return (
    <div className="justify-center items-center min-h-screen">
      ...
      <div className="absolute top-10 left-5 h-26 w-26 overflow-hidden">
      ...
      <div className="absolute bottom-27 left-5 h-26 w-26 overflow-hidden">
        <span className="absolute top-0 left-0 w-full h-full border-2 border-[#00aaff] rounded-lg box-border animate-draw-border pointer-events-none" />
        <img
      ...
      {/* Pulsing Stack */}
      <div className="absolute bottom-28 right-12 flex flex-col gap-2 animate-pulse-stack">
        {[...Array(3)].map((_, i) => (
          <img
            key={i}
